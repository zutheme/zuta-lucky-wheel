...
class LTW_Admin_Upgrade {
    ...
    public function render() {
        ?>
        <div class="wrap ltw-upgrade-wrapper" style="max-width: 1000px; margin: 20px auto; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
